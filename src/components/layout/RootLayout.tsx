...
export function RootLayout({ children }: RootLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      >
        <div className="border border-white/20 rounded-2xl px-8 py-2 shadow-xl backdrop-blur-md relative" style={{ backgroundColor: 'rgba(9, 9, 11, 0.5)' }}>
          ...
          <div className="flex justify-center items-center py-2">
            <div className="hidden md:flex items-center space-x-6">
              {user ? (
                ...
                <>
                  <Link href="/dashboard" className="text-white hover:text-gray-300 px-4 py-2 text-base font-medium transition-colors duration-200">
                    Dashboard
                  </Link>
                  <Link href="/profile" className="text-white hover:text-gray-300 px-4 py-2 text-base font-medium transition-colors duration-200">
                    Profile
                  </Link>
                </>
              ) : (
                ...
                <>
                  <Link href="/about" className="text-white hover:text-gray-300 px-4 py-2 text-base font-medium transition-colors duration-200">
                    About
                  </Link>
                  <Link href="/help" className="text-white hover:text-gray-300 px-4 py-2 text-base font-medium transition-colors duration-200">
                    Help
                  </Link>
                </>
              )}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-24 left-1/2 transform -translate-x-1/2 z-40 w-80">
          <div className="border border-white/20 rounded-2xl px-6 py-4 shadow-xl backdrop-blur-md" style={{ backgroundColor: 'rgba(9, 9, 11, 0.5)' }}>
            {loading ? (
        ...
        <div className="bg-black/95 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 text-sm max-w-md">
                Search across all your favorite streaming platforms in one place.
                Find movies, TV shows, and documentaries from Netflix, Hulu, Amazon Prime, and more.
              </p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            <p className="text-center text-sm text-gray-400">
              © {new Date().getFullYear()} Timeline Target. All rights reserved.
            </p>
          </div>
        </div>
        </div> {/* Close bg-black/95 wrapper */}
      </footer>
    </div>
  )
}